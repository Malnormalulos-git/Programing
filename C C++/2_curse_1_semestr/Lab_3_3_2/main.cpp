...
int main(){
	...
	// principal sum for mortgage
	int psm[n] = {33000, 41000, 55000, 21000, 40000};
	
	Client * client[n];
	
	for(int i =0; i < n; i++)
		client[i] = new Client(names[i], psc[i], psd[i], psm[i]);
	// minimal rate of credit of the bank -1(30..38)
	int mc1 = 30;
	// minimal rate of deposit of the bank -1(18..26)
	int md1 = 18;
	// minimal rate of mortgage of the bank -1(11..19)
	int mm1 = 11;
	// minimal rate of credit of the bank -2(29..37)
	int mc2 = 29;
	// minimal rate of deposit of the bank -2(17..25)
	int md2 = 12;
	// minimal rate of mortgage of the bank -2(9..17)
	int mm2 = 9;
